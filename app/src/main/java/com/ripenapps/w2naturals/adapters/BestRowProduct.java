...
public class BestRowProduct extends RecyclerView.Adapter<BestRowProduct.ViewHolder> {
    ...
    public BestRowProduct(Context context) {
    ...
    @NonNull
    @Override
    public BestRowProduct.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.best_seller_row, parent, false);
        return new ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final BestRowProduct.ViewHolder holder, int position) {
